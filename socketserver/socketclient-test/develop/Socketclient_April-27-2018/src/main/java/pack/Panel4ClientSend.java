...
public class Panel4ClientSend extends JPanel implements ActionListener,
    DocumentListener {

    public Panel4ClientSend(final Control control) {

        logger = logger.getLogger(Panel4ClientSend.class);
        logger.debug(LOG_TAG + ".Panel4ClientSend()");
    ...
    //*                 declare
    //************************************************************************
    private static final String LOG_TAG = "*** " + Panel4ClientSend.class.getSimpleName();
