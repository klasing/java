...
public class View extends ComponentAdapter {
    ...
    private void createAndShowGui() {
        ...
        // add panel for control
        frame.add(new Panel4Control(control), BorderLayout.NORTH);
        // add panel for connection
        panel4Connection = new Panel4Connection(control);
        frame.add(panel4Connection, BorderLayout.CENTER);
        ...
        frame.getRootPane().setDefaultButton(Panel4Control.jbStart);
    }
    ...
    protected static Panel4Connection panel4Connection = null;
}