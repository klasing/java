...
/**
 * Panel for showing a {@link ProducerThread}.
 */
public class Panel4Producer extends JPanel implements ActionListener {
    /**
     * Constructor.
     * @param control {@link Control}
     */
    protected Panel4Producer(final Control control) {

        logger = logger.getLogger(Panel4Producer.class);
        logger.debug(LOG_TAG + "<<constructor>> Panel4Producer()");
        ...
        jtfName.setToolTipText("Name for the producer thread");
        constraint.gridx = 1;
        constraint.gridy = 0;
        ...
        jbDelay.setToolTipText("Commit the delay to the producer thread");
        constraint.gridx = 2;
        constraint.gridy = 1;
        constraint.gridwidth = 1;
        constraint.gridheight = 1;
        ...
        jbRun.setToolTipText("Run the producer thread");
        constraint.gridx = 0;
        constraint.gridy = 2;
        constraint.gridwidth = 1;
        constraint.gridheight = 1;
        ...
        jbInterrupt.setToolTipText("Interrupt the producer thread");
        constraint.gridx = 1;
        constraint.gridy = 2;
        constraint.gridwidth = 1;
        constraint.gridheight = 1;
        ...
        jbResume.setToolTipText("Resume the producer thread");
        constraint.gridx = 2;
        constraint.gridy = 2;
        constraint.gridwidth = 1;
        constraint.gridheight = 1;
        ...
        jbStop.setToolTipText("Stop the producer thread");
        constraint.gridx = 3;
        constraint.gridy = 2;
        constraint.gridwidth = 1;
        constraint.gridheight = 1;
        ...
        jtfState.setToolTipText("State of the producer thread");
        constraint.gridx = 1;
        constraint.gridy = 3;
        constraint.gridwidth = 2;
        constraint.gridheight = 1;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch (action_command) {
            case "Commit":
                ...
                control.setDelayProducerThread(
            ...
            case "Interrupt":
                ...
                // send message to control
                control.interruptProducerThread(true);
            ...
            case "Resume":
                ...
                // send message to control
                control.interruptProducerThread(false);
    ...
    //*                 declare
    //************************************************************************
    private static final String LOG_TAG = "*** " + Panel4Producer.class.getSimpleName();
