...
SET CLASSPATH=%CLASSPATH%;.\lib\google-api-client-1.22.0-sources.jar;.\lib\jackson-core-2.1.3.jar;.\lib\google-http-client-1.22.0.jar;.\lib\google-http-client-jackson2-1.22.0.jar;.\lib\google-oauth-client-1.22.0.jar
...
ECHO [RUN]
%JAVA_HOME%java src.TestJackson2
